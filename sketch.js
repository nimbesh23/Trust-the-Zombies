...
function setup() {
  ...
  leftWall = new Base(30, height / 2 + 50, 60, 100, "#8d6e63", true);
  rightWall = new Base(width - 30, height / 2 + 50, 60, 100, "#8d6e63", true);

  /*bridge = new Base(15, { x: width / 2 - 400, y: height / 2 });
  jointPoint = new Base(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);*/

  bridge = new Bridge(25, { x: 30, y: height / 2 });
  jointPoint = new Base(width - 30, height / 2 + 10, 40, 20, "#8d6e63", true);
